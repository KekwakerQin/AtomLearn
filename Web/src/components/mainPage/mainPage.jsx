	...
	<section className="mainpage-section">
		<div className="mainpage-text">
			<h1 className="mainpage-title">
				{text.mainPage.mainPageTitle}
			</h1>
			<span className="mainpage-subtitle">
				{text.mainPage.mainPageSubtitle}
			</span>
			<Button className = 'mainpage-section-button standart-button' type="button" onClick={() => navigate('/boards')}>
				{text.mainPage.mainPageStartButton}
			</Button>
		</div>
		<img src="../../images/Atom-mainPage-image.png" alt="mainpage-image" className="mainpage-img" />
	</section>
	<footer className="footer">
		<div className="footer-navbar-container">
			<Button className = 'footer-button boards-button' type="button" onClick={() => navigate('/boards')}>
		...
		<Button className = 'footer-button friends-button' type="button">
		...
		<Button className = 'footer-button dashboard-button' type="button"onClick={handleLogout}>
